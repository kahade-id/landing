    ...
    <section id="faq" ref={sectionRef} className="faq-root relative overflow-hidden py-20 sm:py-28 lg:py-36" style={{ background: "#FFFFFF" }}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className={`${cls("faq-fade-up", inView, "faq-d1")} text-[2rem] sm:text-[2.5rem] lg:text-[2.8rem] font-extrabold text-black leading-[1.1] tracking-tight mb-5`} style={{ fontFamily: "var(--font-sans)" }}>
