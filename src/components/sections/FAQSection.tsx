    ...
    <div className={`faq-item faq-fade-up ${inView ? "fv" : ""} ${delayClass} px-0`}>
      ...
      >
        ...
        <div className={`flex-shrink-0 w-7 h-7 rounded-lg flex items-center justify-center transition-colors ${open ? "bg-black" : "bg-black/[.05] group-hover:bg-black/10"}`}>
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none" stroke={open ? "white" : "rgba(0,0,0,.6)"} strokeWidth="2" strokeLinecap="round">
...
const AbstractBg = () => (
  <svg className="absolute inset-0 w-full h-full pointer-events-none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
    ...
    <pattern id="faq-dots" width="32" height="32" patternUnits="userSpaceOnUse">
      <circle cx="1" cy="1" r="1" fill="rgba(0,0,0,.04)" />
    </pattern>
    <rect width="100%" height="100%" fill="url(#faq-dots)" />
    <circle cx="92%" cy="10%" r="220" fill="none" stroke="rgba(0,0,0,.04)" strokeWidth="1" />
    <circle cx="92%" cy="10%" r="140" fill="none" stroke="rgba(0,0,0,.03)" strokeWidth="1" />
  </svg>
);
