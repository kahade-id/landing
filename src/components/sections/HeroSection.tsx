      ...
      <div className="card p-5 relative overflow-hidden">
        ...
        <div className="mb-4">
          ...
          <div className="h-1.5 bg-ink-7 rounded-full overflow-hidden">
            <div 
              className="h-full bg-ink rounded-full transition-all duration-75"
        ...
        {/* Parties */}
        <div className="mt-4 flex items-center justify-between bg-ink-4 rounded-lg p-3 border border-ink-7">
