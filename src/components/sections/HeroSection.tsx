    ...
    <div className="relative w-full max-w-[340px] xl:max-w-[380px] mx-auto select-none">
      ...
      <div className="hero-card-ui hero-float-card p-5 relative overflow-hidden">
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            <p style={{ fontSize: "var(--text-2xs)", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--color-ink-45)", fontFamily: "var(--font-sans)" }}>Dana Escrow</p>
            <p style={{ fontSize: "var(--text-xl)", fontWeight: 800, color: "var(--color-ink)", fontFamily: "var(--font-sans)", letterSpacing: "-0.03em", marginTop: 2 }}>Rp 12.500.000</p>
          </div>
        ...
        <div className="mb-4">
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
            <span style={{ fontSize: "var(--text-xs)", fontWeight: 500, color: "var(--color-ink-45)", fontFamily: "var(--font-sans)" }}>Verifikasi pengiriman</span>
            <span style={{ fontSize: "var(--text-xs)", fontWeight: 700, color: "var(--color-ink)", fontFamily: "var(--font-sans)" }}>{Math.round(progress)}%</span>
          </div>
          ...
          <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "7px 0", borderBottom: i < 3 ? `1px solid var(--color-ink-09)` : "none" }}>
            ...
            {step.active && (
              <div style={{ marginLeft: "auto" }}>
                <span style={{ fontSize: "var(--text-2xs)", fontWeight: 700, color: "var(--color-ink)", background: "var(--color-ink-07)", padding: "3px 7px", borderRadius: "var(--radius-full)", letterSpacing: "0.05em", textTransform: "uppercase", fontFamily: "var(--font-sans)" }}>
                  Menunggu
                </span>
              </div>
            )}
        ...
        <div style={{ marginTop: 14, display: "flex", alignItems: "center", justifyContent: "space-between", background: "var(--color-ink-04)", borderRadius: "var(--radius-xs)", padding: "10px 12px", border: `1px solid var(--color-ink-07)` }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div style={{ width: 28, height: 28, borderRadius: "50%", background: "var(--color-ink)", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <span style={{ fontSize: "var(--text-2xs)", fontWeight: 700, color: "var(--color-surface)", fontFamily: "var(--font-sans)" }}>AR</span>
            </div>
            <div>
              <p style={{ fontSize: "var(--text-2xs)", color: "var(--color-ink-45)", fontFamily: "var(--font-sans)", fontWeight: 500 }}>Pembeli</p>
              <p style={{ fontSize: "var(--text-xs)", fontWeight: 600, color: "var(--color-ink)", fontFamily: "var(--font-sans)" }}>Ari Ramadhan</p>
            </div>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div>
              <p style={{ fontSize: "var(--text-2xs)", color: "var(--color-ink-45)", fontFamily: "var(--font-sans)", fontWeight: 500, textAlign: "right" }}>Penjual</p>
              <p style={{ fontSize: "var(--text-xs)", fontWeight: 600, color: "var(--color-ink)", fontFamily: "var(--font-sans)" }}>Toko Budi</p>
            </div>
            <div style={{ width: 28, height: 28, borderRadius: "50%", background: "var(--color-ink-09)", display: "flex", alignItems: "center", justifyContent: "center", border: `1px solid var(--color-ink-12)` }}>
              <span style={{ fontSize: "var(--text-2xs)", fontWeight: 700, color: "var(--color-ink-60)", fontFamily: "var(--font-sans)" }}>TB</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="hero-float-badge hero-card-ui absolute -left-10 top-8 px-3 py-2.5 flex items-center gap-2.5" style={{ animationDelay: "1s", zIndex: 10, minWidth: 148 }}>
        ...
        <div>
          <p style={{ fontSize: "var(--text-2xs)", fontWeight: 600, color: "var(--color-ink)", fontFamily: "var(--font-sans)", lineHeight: 1 }}>Dana Aman</p>
          <p style={{ fontSize: "var(--text-2xs)", color: "var(--color-ink-45)", fontFamily: "var(--font-sans)", marginTop: 2 }}>Terproteksi 100%</p>
        </div>
      </div>
      ...
      <div className="hero-float-badge hero-card-ui absolute -right-8 bottom-10 px-3 py-2 flex items-center gap-2" style={{ animationDelay: "2s", zIndex: 10 }}>
        ...
        <span style={{ fontSize: "var(--text-xs)", fontWeight: 600, color: "var(--color-ink)", fontFamily: "var(--font-sans)", whiteSpace: "nowrap" }}>Transaksi Live</span>
      </div>

      {/* Floating badge — top right */}
      <div className="hero-float-badge hero-card-ui absolute -right-6 top-6 px-3 py-2.5" style={{ animationDelay: "0.5s", zIndex: 10 }}>
        <p style={{ fontSize: "var(--text-2xs)", fontWeight: 600, color: "var(--color-ink-45)", fontFamily: "var(--font-sans)", textTransform: "uppercase", letterSpacing: "0.08em" }}>Monitoring</p>
        <p style={{ fontSize: "var(--text-sm)", fontWeight: 800, color: "var(--color-ink)", fontFamily: "var(--font-sans)", letterSpacing: "-0.02em" }}>24/7</p>
      </div>
    </div>
  );
};
...
export default function HeroSection() {
  ...
  return (
    <section
      ...
      style={{ fontFamily: "var(--font-sans)", background: "var(--color-surface)", minHeight: "calc(100vh - 104px)" }}
    >
      <HeroAbstractBg />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-12 items-center">
          ...
          <div className="flex flex-col gap-7 max-w-xl">
            ...
            <div className="hero-anim-up d-1 inline-flex items-center gap-2 self-start px-3.5 py-2 rounded-full border border-black/10 bg-white/80">
              ...
              <span style={{ fontSize: "var(--text-xs)", fontWeight: 600, color: "var(--color-ink-60)", fontFamily: "var(--font-sans)", letterSpacing: "0.03em" }}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-14 pb-14">
        <div className="hero-anim-up d-11">
          ...
          <div className="flex items-center gap-4 mb-5">
            <div style={{ flex: 1, height: 1, background: "var(--color-ink-09)" }} />
            <span style={{
