...
const FloatingUICard = () => {
  ...
  return (
    <div className="relative w-full max-w-[320px] xl:max-w-[360px] mx-auto select-none">
      {/* Main card */}
      <div className="card card-compact relative overflow-hidden">
        {/* Header row */}
      ...
      {/* Floating badges */}
      <div className="absolute -left-8 top-6 card card-tight flex items-center gap-2.5 z-10 animate-[float_5s_ease-in-out_infinite]">
        <div className="icon-box bg-ink text-white">
      ...
      <div className="absolute -right-6 bottom-8 card card-tight flex items-center gap-2 z-10 animate-[float_6s_ease-in-out_infinite_1s]">
      ...
      <div className="absolute -right-4 top-4 card card-tight z-10 animate-[float_5.5s_ease-in-out_infinite_0.5s]">
