    ...
    >
      ...
      <div style={{ display:"flex", alignItems:"flex-start", justifyContent:"space-between", marginBottom:22, gap:10 }}>
        <div style={{ display:"flex", alignItems:"center", gap:12 }}>
          ...
          <div className="hw-num-badge" style={{ background:numBg }}>
            <span style={{ fontFamily:"var(--font-sans)", fontSize:12, fontWeight:800, color:isF?"rgba(255,255,255,.6)":"rgba(0,0,0,0.42)", letterSpacing:".02em" }}>
              {step.num}
            </span>
          </div>
          {/* Icon box */}
        ...
        <div style={{
          ...
          fontSize:10.5, fontWeight:700, color:isF?"rgba(255,255,255,.55)":"rgba(0,0,0,0.45)",
      ...
      <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", paddingTop:14, borderTop:`1px solid ${borderColor}` }}>
        <div style={{ display:"flex", alignItems:"center", gap:7, padding:"5px 11px", borderRadius:99, background:timeBg }}>
          ...
          <span style={{ fontSize:11, fontWeight:600, color:isF?"rgba(255,255,255,.4)":"rgba(0,0,0,0.38)", fontFamily:"var(--font-sans)" }}>
            {step.time}
          </span>
        </div>
    ...
    <div className={`hw-${isEven?"fl":"fr"} hw-d${2+idx} ${inView?"hv":""}`}
      ...
      <div style={{ display:"flex", alignItems:"center", gap:12 }}>
        ...
        <div style={{
          ...
          fontSize:10.5, fontWeight:700, color:"rgba(0,0,0,0.45)",
        ...
        <div style={{ display:"flex", alignItems:"center", gap:6 }}>
          ...
          <span style={{ fontSize:11, fontWeight:600, color:"rgba(0,0,0,0.45)", fontFamily:"var(--font-sans)" }}>{step.time}</span>
        </div>
      </div>
      ...
      <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
        {step.details.map((d: string, i: number) => (
          <div key={i} style={{ display:"flex", alignItems:"center", gap:10 }}>
            <CheckSmall/>
            <span style={{ fontSize:13.5, fontWeight:500, color:"rgba(0,0,0,0.45)", fontFamily:"var(--font-sans)" }}>{d}</span>
          </div>
        ))}
      </div>
    </div>
  ...
  const visual = (
    <div className={`hw-${isEven?"fr":"fl"} hw-d${3+idx} ${inView?"hv":""}`}
      ...
      <div className="hw-float" style={{
        ...
        <div style={{ fontSize:10, fontWeight:700, color:"rgba(0,0,0,0.45)", fontFamily:"var(--font-sans)", textTransform:"uppercase", letterSpacing:".08em", marginBottom:2 }}>
          Status
        </div>
