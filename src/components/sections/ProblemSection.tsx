...
const CheckIcon = ({ white = false }) => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
    <circle cx="10" cy="10" r="10" fill={white ? "rgba(255,255,255,.1)" : "rgba(0,0,0,0.06)"}/>
    <path d="M6.5 10L8.8 12.3L13.5 7.5"
      stroke={white ? "rgba(255,255,255,.85)" : "rgba(0,0,0,0.65)"}
...
const WalletIcon = ({ size = 22, white = false }) => (
  <svg width={size} height={size} viewBox="0 0 22 22" fill="none"
    stroke={white ? "rgba(255,255,255,.75)" : "rgba(0,0,0,0.5)"}
    strokeWidth="1.65" strokeLinecap="round" strokeLinejoin="round">
    <rect x="2" y="5" width="18" height="14" rx="2.5"/>
    <path d="M2 10h18"/>
    <circle cx="16" cy="15" r="1.2" fill={white ? "rgba(255,255,255,.75)" : "rgba(0,0,0,0.5)"} stroke="none"/>
  </svg>
);
...
const LockIcon = ({ white = false, size = 16 }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none"
    ...
    <circle cx="8" cy="11" r="1.2" fill={white ? "rgba(255,255,255,.75)" : "rgba(0,0,0,0.5)"} stroke="none"/>
  </svg>
);
...
const MoneyGoneVisual = ({ inView }: { inView: boolean }) => (
  <div style={{ position:"relative", height:180, display:"flex", alignItems:"center", justifyContent:"center", margin:"4px 0 20px" }}>
    ...
    {[
      ...
      <div key={i} className="pb-float" style={{
        ...
        <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
          ...
          <path d="M4 7.5c0-.8.9-1.5 2-1.5s2-.7 2-1.5S9 3 6 3M6 3V2M6 9v1M4.5 8.5h3" stroke="rgba(0,0,0,0.55)" strokeWidth="1" strokeLinecap="round"/>
        </svg>
        ...
        <svg width="10" height="10" viewBox="0 0 10 10" fill="none" className="pb-arrow-ani">
          <path d="M1 9L9 1M9 1H4M9 1V6" stroke="rgba(0,0,0,0.55)" strokeWidth="1.4" strokeLinecap="round"/>
        </svg>
      </div>
    ))}
    ...
    <div className="pb-float" style={{
      ...
      <span style={{ fontSize:18, color: "rgba(0,0,0,0.5)" }}>?</span>
    </div>

    {/* Bottom label */}
    <div style={{
      position:"absolute", bottom:"0%", right:"15%",
      background:"rgba(0,0,0,0.1)", borderRadius: "var(--radius-sm)",
      padding:"4px 10px", display:"flex", alignItems:"center", gap:5
    }}>
      <div className="pb-blink" style={{ width:6, height:6, borderRadius:"50%", background:"rgba(0,0,0,0.5)" }}/>
      <span style={{ fontWeight:600, color:"rgba(0,0,0,0.5)" }}>Tidak ada jaminan</span>
    </div>
  </div>
);
  ...
  <div style={{ position:"relative", height:180, display:"flex", alignItems:"center", justifyContent:"center", margin:"4px 0 20px" }}>
    ...
    <div className="pb-float" style={{
      ...
      <svg width="11" height="11" viewBox="0 0 11 11" fill="none">
        ...
        <path d="M3 5.5l2 2 3-3" stroke="rgba(0,0,0,0.6)" strokeWidth="1.3" strokeLinecap="round"/>
      </svg>
      <span style={{ fontWeight:700, color:"rgba(0,0,0,0.6)" }}>Barang terkirim</span>
    </div>
    ...
    {[
      ...
      <div key={i} className="pb-float" style={{
        ...
        <WalletIcon size={12}/>
        <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
          <line x1="2.5" y1="2.5" x2="7.5" y2="7.5" stroke="rgba(0,0,0,0.55)" strokeWidth="1.4" strokeLinecap="round"/>
          <line x1="7.5" y1="2.5" x2="2.5" y2="7.5" stroke="rgba(0,0,0,0.55)" strokeWidth="1.4" strokeLinecap="round"/>
        </svg>
        <span style={{ fontWeight:600, color:"rgba(0,0,0,0.55)" }}>Belum cair</span>
      </div>
    ))}
    ...
    <div style={{
      ...
      <div className="pb-blink" style={{ width:6, height:6, borderRadius:"50%", background:"rgba(0,0,0,0.5)" }}/>
      <span style={{ fontWeight:600, color:"rgba(0,0,0,0.5)" }}>Menunggu tanpa kepastian</span>
    </div>
  </div>
);
      ...
      return (
        <div key={i} className="pb-float" style={{
          ...
          <div style={{
            ...
            <p style={{ fontSize:9.5, fontWeight:700, color:"rgba(255,255,255,.85)", margin:"0 0 1px", letterSpacing:".02em" }}>
              {node.label}
            </p>
            <p style={{ fontSize:8.5, color:"rgba(255,255,255,.38)" }}>
              {node.sub}
            </p>
          </div>
        </div>
          ...
          <div style={{ textAlign:"center", marginBottom:72 }}>
            ...
            <div className={c("pb-fu pb-d1")}>
              <h2 style={{
                ...
                Transaksi Online
                {" "}<span style={{ color:"rgba(0,0,0,0.28)" }}>Penuh</span>
            ...
            <div className={c("pb-fu pb-d2")}>
              <p style={{
                ...
                color:"rgba(0,0,0,0.5)", lineHeight:1.78,
              ...
              <div style={{ padding:"0 24px 24px" }}>
                {buyerRisks.map((r,i) => (
                  <div key={i} className={`pb-risk-row pb-fu pb-d${4+i} ${inView?"pv":""}`}>
                    ...
                    <div>
                      <p style={{
                        fontWeight:600, margin:"0 0 3px", lineHeight:1.3
                      }}>{r.title}</p>
                      <p style={{
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
              ...
              <div className={c("pb-fs pb-d4")} style={{
                ...
                <div style={{
                  ...
                  <span style={{
                    fontWeight:800, color:"rgba(255,255,255,.6)",
                    letterSpacing:".06em"
                  }}>VS</span>
                </div>
                <div style={{ flex:1, height:1, background:"rgba(0,0,0,0.1)" }}/>
              ...
              <div className={`pb-sol-card pb-fs pb-d5 ${inView?"pv":""}`}>
                ...
                <div style={{ padding:"28px", position:"relative", zIndex:1 }}>
                  ...
                  <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:22 }}>
                    ...
                    <div>
                      <h3 style={{
                        fontSize:18, fontWeight:800, letterSpacing:"-.03em", lineHeight:1.15
                  ...
                  <div style={{ marginTop:24, paddingTop:20, borderTop:"1px solid rgba(255,255,255,.08)" }}>
                    <Link href={homeAnchors.howItWorks} className="btn-inv-primary w-full justify-center">
          ...
          <div className={c("pb-fu pb-d9")} style={{ marginTop:56, textAlign:"center" }}>
            <div style={{
              ...
              <p style={{
                ...
                fontWeight:700, letterSpacing:"-.03em", margin:"0 0 8px",
                lineHeight:1.35
              }}>
