  ...
  <div style={{ position:"relative", height:180, display:"flex", alignItems:"center", justifyContent:"center", margin:"4px 0 20px" }}>
    ...
    {[
      ...
      <div key={i} className="pb-float" style={{
        ...
        <span style={{ fontSize:10, fontWeight:700, color:"rgba(0,0,0,0.55)", fontFamily:"var(--font-sans)" }}>
          {p.val}
        </span>
        {/* Arrow flying away */}
    ...
    <div style={{
      ...
      <span style={{ fontSize:10, fontWeight:600, color:"rgba(0,0,0,0.5)", fontFamily:"var(--font-sans)" }}>Tidak ada jaminan</span>
    </div>
  </div>
);
...
const BoxShippedVisual = ({ inView }: { inView: boolean }) => (
  <div style={{ position:"relative", height:180, display:"flex", alignItems:"center", justifyContent:"center", margin:"4px 0 20px" }}>
    ...
    <div className="pb-float" style={{
      ...
      <span style={{ fontSize:10, fontWeight:700, color:"rgba(0,0,0,0.6)", fontFamily:"var(--font-sans)" }}>Barang terkirim</span>
    </div>
    ...
    {[
      ...
      <div key={i} className="pb-float" style={{
        ...
        <span style={{ fontSize:10, fontWeight:600, color:"rgba(0,0,0,0.55)", fontFamily:"var(--font-sans)" }}>Belum cair</span>
      </div>
    ))}
    ...
    <div style={{
      ...
      <div className="pb-blink" style={{ width:6, height:6, borderRadius:"50%", background:"rgba(0,0,0,0.5)" }}/>
      <span style={{ fontSize:10, fontWeight:600, color:"rgba(0,0,0,0.5)", fontFamily:"var(--font-sans)" }}>Menunggu tanpa kepastian</span>
    </div>
  </div>
);
