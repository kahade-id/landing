...
export default function SecuritySection() {
  ...
  return (
    <section id="keamanan" ref={sectionRef} className="px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
      <div className="mx-auto w-full max-w-6xl rounded-[30px] bg-[#111] px-6 py-12 text-white shadow-2xl sm:px-10 sm:py-16 lg:px-16 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <header className="mx-auto max-w-3xl text-center">
            <div className="inline-flex items-center gap-2 mb-5 px-3.5 py-2 rounded-full border border-white/10 bg-white/5">
              <span style={{ position: "relative", display: "flex", width: 7, height: 7 }}>
                <span style={{ position: "absolute", inset: 0, borderRadius: "50%", background: "#fff", opacity: 0.35, animation: "ping-slow 1.8s ease infinite" }} />
          ...
          <div className="flex flex-wrap items-center justify-center gap-5 sm:gap-8">
            {certifications.map((cert, i) => (
              ...
              >
                ...
                <span className="text-[10px] font-medium text-white/35 leading-tight px-2">
                  {cert.sub}
                </span>
              </div>
            ))}
          ...
          <div className="mx-auto mt-4 max-w-3xl text-center">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              <Link
                href={homeAnchors.cta}
                className="inline-flex items-center gap-2 px-6 py-3 bg-white text-black text-sm font-bold rounded-xl hover:-translate-y-0.5 transition-transform"
              >
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-6 py-3 text-white/60 text-sm font-semibold border border-white/10 rounded-xl hover:text-white hover:border-white/20 transition-colors"
              >
                Pelajari Keamanan
              </Link>
            </div>
